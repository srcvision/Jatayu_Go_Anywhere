...
const ConfirmRidePopup = forwardRef((ref, props) => {
  return (
    <div
      ref={ref}
    ...
    >
      ...
      <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">
        New Ride confirm ride are  Available
      </h2>
      ...
      <div className="flex gap-4 px-6 pb-4">
        <button className="w-1/2 bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-semibold shadow-md transition duration-300">
          Accept Ride
        </button>
        <button
          onClick={() => props.setRidePopupPanel(false)}

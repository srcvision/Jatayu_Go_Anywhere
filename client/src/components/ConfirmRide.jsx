...
const ConfirmRide = forwardRef((props, ref) => {
  return (
    <div
      ref={ref}
    ...
    >
      ...
      }} className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl text-sm font-semibold shadow-lg transition duration-300">
        Confirm Ride
      </button>
    </div>
  );
